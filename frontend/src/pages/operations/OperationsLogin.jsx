...
const OperationsLogin = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-cyan-50 to-blue-100 py-12 px-4">
      <Card className="w-full max-w-md shadow-2xl rounded-xl">
        <div className="text-center mb-8">
          <div className="text-5xl mb-2">📋</div>
          <Title level={2} className="text-cyan-600 mb-1">Operations Portal</Title>
          <Text className="text-gray-500">EDSA Operations Management</Text>
        </div>
        ...
        <div className="text-center mt-4">
          <Text className="text-gray-400 text-sm">Demo: ops_manager / ops123</Text>
        </div>
      </Card>
    </div>
  );
