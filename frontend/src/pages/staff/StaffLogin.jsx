    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-teal-100 py-12 px-4">
      <Card className="w-full max-w-md shadow-2xl rounded-xl">
        <div className="text-center mb-8">
          ...
          <Title level={2} className="text-green-600 mb-1">Staff Portal</Title>
          <Text className="text-gray-500">EDSA Staff Login</Text>
        </div>
        ...
        <div className="text-center mt-4">
          <Text className="text-gray-400 text-sm">Demo: staff_jane / staff123</Text>
        </div>
      </Card>
    </div>
  );
